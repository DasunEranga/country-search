...
const SearchResults = () => {
    ...
    return (
        <div className="relative lg:row-start-2 lg:row-end-3 after:block after:absolute after:w-full after:h-24 after:bottom-0 after:left-0 after:bg-gradient-to-b after:from-transparent after:to-white">
